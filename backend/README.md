...
## Project Structure
    ...
    ├── testapiautostorybo_117800  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_117800`
...
2. Clone this repo and `cd testapiautostorybo_117800`
